...
def summarize_results(df, t_stat, p_val, bayes_results, uplift_summary):
    ...
    if abs(classical_delta) >= practical_threshold:
        classical_practical_msg ="The observed difference of "+classical_delta+" is practically significant."
    else:
    ...
    if abs(bayes_delta) >= practical_threshold:
        bayes_practical_msg = "The observed difference of "+classical_delta+" is practically significant."
    else:
